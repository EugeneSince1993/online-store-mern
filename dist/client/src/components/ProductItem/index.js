...
const ProductItem = ({ phoneImage, rating, testimonials, productName, priceValue, productId, productCode }) => {
    ...
    const favoriteItem = (0, react_redux_1.useSelector)((0, selectors_2.selectFavoriteItemById)(productId));
