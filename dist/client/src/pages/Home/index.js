...
const Home = () => {
    ...
    const skeletonsAbove700 = [...new Array(8)].map((_, index) => {
        return (0, jsx_runtime_1.jsx)(components_1.ProductItemSkeletonAbove700, { className: Home_module_scss_1.default.productSkeleton }, index);
    });
