...
const FavoriteItem = ({ _id, name, price, imageUrl, productCode }) => {
    const dispatch = (0, hooks_1.useAppDispatch)();
    const cartItem = (0, react_redux_1.useSelector)((0, selectors_1.selectCartItemById)(_id));
    const onClickRemove = () => {
        if (window.confirm('Вы действительно хотите удалить товар?')) {
            dispatch((0, favoriteSlice_1.removeFavoriteItem)(_id));
        }
    };
